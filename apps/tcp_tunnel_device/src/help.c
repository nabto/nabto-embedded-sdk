...
void print_help() {
    ...
    printf("%s" NEWLINE, "                   $HOME/.nabto/edge on linux and mac.");
    ...
    printf("%s" NEWLINE, "");
    printf("%s" NEWLINE, "The files is by default located in the folder `~/.nabto/edge`. The");
    printf("%s" NEWLINE, "location can be overriden by the home-dir option. In this case");
    printf("%s" NEWLINE, "basefolder is `${home-dir}`.");
    printf("%s" NEWLINE, "");
