 ...
 * called the default platform calloc and free are used.
 */

typedef void* (*nabto_device_allocator_calloc)(size_t n, size_t size);
typedef void (*nabto_device_allocator_free)(void* ptr);
