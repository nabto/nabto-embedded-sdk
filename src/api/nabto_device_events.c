...
const int NABTO_DEVICE_EVENT_INVALID_FINGERPRINT   = (int)NC_DEVICE_EVENT_INVALID_FINGERPRINT;
const int NABTO_DEVICE_EVENT_INVALID_PRODUCT_ID   = (int)NC_DEVICE_EVENT_INVALID_PRODUCT_ID;
const int NABTO_DEVICE_EVENT_INVALID_DEVICE_ID   = (int)NC_DEVICE_EVENT_INVALID_DEVICE_ID;
