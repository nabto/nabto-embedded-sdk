...
void nm_iam_test_add_ssh_tunnel_policy(struct nm_iam* iam)
{
    ...
    nm_iam_boolean_expression_add_expression(
        statement->conditions,
        nm_iam_expression_string_equal(
            nm_iam_predicate_item_attribute(iam, "tcptunnel:host"),
            nm_iam_predicate_item_string("localhost")
            )
        );
    nm_iam_boolean_expression_add_expression(
        statement->conditions,
        nm_iam_expression_number_equal(
            nm_iam_predicate_item_attribute(iam, "tcptunnel:port"),
            nm_iam_predicate_item_number(22)
            )
        );
