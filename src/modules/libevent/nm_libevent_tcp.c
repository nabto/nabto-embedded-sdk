...
static np_error_code tcp_create(struct np_tcp_object* obj, struct np_tcp_socket** sock);
...
np_error_code tcp_create(struct np_tcp_object* obj, struct np_tcp_socket** sock)
{
