...
static void async_bind_mdns_ipv4(struct np_udp_socket* sock, struct np_completion_event* completionEvent);
static void async_bind_mdns_ipv6(struct np_udp_socket* sock, struct np_completion_event* completionEvent);
...
static struct nm_mdns_udp_bind_functions module = {
    .async_bind_mdns_ipv4 = &async_bind_mdns_ipv4,
...
{
    np_error_code ec = async_bind_mdns_ipv4_ec(sock);
...
{
    np_error_code ec = async_bind_mdns_ipv6_ec(sock);
    np_completion_event_resolve(completionEvent, ec);
}
