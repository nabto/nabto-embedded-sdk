...
typedef np_error_code (*nc_iam_check_access_function_override)(uint64_t connectionRef,const char* action, void* attributes, size_t attributesLength, void* userData);
...
struct nc_iam {
    ...
    nc_iam_check_access_function_override checkAccessFunction;
    void* checkAccessFunctionUserData;
};
