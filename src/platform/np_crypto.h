...
typedef void (*np_crypto_received_callback)(const np_error_code ec, uint8_t channelId, uint64_t sequence,
...
struct np_crypto_module {
    ...
    np_error_code (*async_close)(struct np_platform* pl, np_crypto_context* ctx,
