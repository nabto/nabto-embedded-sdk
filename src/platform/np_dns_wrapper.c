...
{
    return dns->mptr->async_resolve_v4(dns, host, ips, ipsSize, ipsResolved, completionEvent);
}
...
{
    return dns->mptr->async_resolve_v6(dns, host, ips, ipsSize, ipsResolved, completionEvent);
}
