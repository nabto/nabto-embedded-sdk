...
{
    return dns->vptr->async_resolve_v4(dns->data, host, ips, ipsSize, ipsResolved, completionEvent);
}
...
{
    return dns->vptr->async_resolve_v6(dns->data, host, ips, ipsSize, ipsResolved, completionEvent);
}
